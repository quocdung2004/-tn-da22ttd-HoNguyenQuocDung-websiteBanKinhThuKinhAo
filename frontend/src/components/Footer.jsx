      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 md:py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 md:gap-12">
          ...
          <div className="flex flex-col gap-4">
            ...
            <p className="text-sm leading-relaxed text-slate-400">
              Hệ thống thử kính ảo (AR) giúp khách hàng trải nghiệm sản phẩm trực tuyến một cách chân thực nhất.
            </p>
          </div>
          ...
          <div className="flex flex-col gap-4">
            ...
            <ul className="flex flex-col gap-3 text-sm">
              <li className="flex items-start gap-2.5">
                ...
                <span>Nhị Long - Vĩnh Long</span>
              </li>
              <li className="flex items-center gap-2.5">
                <Phone className="w-4 h-4 text-blue-500 shrink-0" />
                <a href="tel:0336766665" className="hover:text-blue-500 transition-colors">0336766665</a>
              </li>
              <li className="flex items-center gap-2.5">
                <Mail className="w-4 h-4 text-blue-500 shrink-0" />
                <a href="mailto:jungdung2004@gmail.com" className="hover:text-blue-500 transition-colors">jungdung2004@gmail.com</a>
              </li>
            </ul>
        ...
        <div className="flex flex-col md:flex-row justify-between items-center gap-6 text-xs text-slate-500">
          <div className="flex flex-col gap-1.5 text-center md:text-left">
            ...
            <p>
              Khóa luận tốt nghiệp: &ldquo;Xây dựng website bán kính tích hợp chức năng thử kính ảo&rdquo;
            </p>
          </div>
